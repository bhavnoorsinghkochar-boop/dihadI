              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-300 pt-2">
                  ...
                  <strong className="text-amber-400 font-bold">
                    {remainingZeroJobs + JOBS_COUNT} Zero-Commission Jobs
                  </strong>{" "}
                  ready! You will keep 100% of your earnings on every job.{" "}
                </p>{" "}
              </div>{" "}
...
// pay?pa=dihadi.vip@okhdfcbank&pn=Dihadi%20VIP%20Pass&am=${PRICE}&cu=INR&tn=Worker%20VIP%206%20Jobs%20Pass`)}`}
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-3 flex items-center justify-between">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs font-black text-white">
                      {" "}
                      {remainingZeroJobs} of {JOBS_COUNT} zero-fee jobs
                      remaining{" "}
                    </p>{" "}
                    {totalSaved > 0 && (
                      <p className="text-[11px] text-amber-400 font-bold">
                        {" "}
                        🎉 Saved ₹{totalSaved} in platform commission so
                        far!{" "}
                      </p>
                    )}{" "}
                  </div>{" "}
                ...
                <div className="grid grid-cols-1 gap-2 text-xs">
                  ...
                  <div className="flex items-start gap-2.5 bg-amber-950/40 p-2.5 rounded-xl border border-amber-500/40">
                    ...
                    <div>
                      ...
                      <strong className="text-amber-300">
                        ⚡ Instant Aadhaar Card Verification:
                      </strong>{" "}
                      <p className="text-slate-300 text-[11px]">
                        {" "}
                        Get immediate verified gold badge on your profile
                        without waiting in the manual approval queue!{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                  <div className="flex items-start gap-2.5 bg-slate-850 p-2.5 rounded-xl border border-slate-800">
                    ...
                    <div>
                      ...
                      <strong className="text-white">
                        6 Jobs Without Commission:
                      </strong>{" "}
                      <p className="text-slate-400 text-[11px]">
                        {" "}
                        The 20% platform cut is waived to 0%. If wage is ₹900,
                        you get full ₹900 directly into your wallet!{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                  <div className="flex items-start gap-2.5 bg-slate-850 p-2.5 rounded-xl border border-slate-800">
                    ...
                    <div>
                      {" "}
                      <strong className="text-white">
                        Save Up to ₹1,800 - ₹3,000+:
                      </strong>{" "}
                      <p className="text-slate-400 text-[11px]">
                        {" "}
                        The pass easily pays for itself within the first few
                        jobs.{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                  <div className="flex items-start gap-2.5 bg-slate-850 p-2.5 rounded-xl border border-slate-800">
                    ...
                    <div>
                      {" "}
                      <strong className="text-white">
                        Top 5 Radar Priority:
                      </strong>{" "}
                      <p className="text-slate-400 text-[11px]">
                        {" "}
                        VIP badge workers appear with top priority ranking in
                        client search results and auto-hiring.{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                </div>{" "}
                ...
                {selectedMethod === "WALLET" && !hasEnoughWalletBalance && (
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-3 text-xs space-y-2 animate-in fade-in">
                    ...
                    <p className="text-[11px] text-slate-300">
                      {" "}
                      You need ₹{PRICE - walletBalance} more in your wallet to
                      activate directly.{" "}
                    </p>{" "}
                    <div className="flex gap-2">
                      {" "}
        ...
        <div className="bg-slate-950 p-3 text-center border-t border-slate-800/80 text-[10px] text-slate-500 shrink-0">
          {" "}
          🔒 Transparent 0% Commission Policy • Instant automatic activation •
          No hidden charges{" "}
        </div>{" "}
      </div>{" "}
    </div>
