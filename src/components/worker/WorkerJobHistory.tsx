          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xl font-black text-white">
                Certified Job & Payout History
              </h3>{" "}
            </div>{" "}
            <p className="text-xs text-slate-400">
              {" "}
              Verified record of completed daily wage assignments, client
              reviews, and direct UPI settlements.{" "}
            </p>{" "}
          </div>{" "}
          <div className="flex items-center gap-2">
            {" "}
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 sm:p-12 text-center space-y-4 shadow-xs max-w-xl mx-auto">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-slate-500 max-w-md mx-auto leading-relaxed">
              {" "}
              When you accept daily job broadcasts, verify start OTP with
              employers, and complete the work, your verified completion
              receipts, instant UPI earnings, and employer testimonials will
          ...
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 text-left text-xs space-y-2">
            ...
            <ul className="text-slate-600 space-y-1 text-[11px] list-disc list-inside">
              {" "}
              <li>
                Accept broadcast jobs in your trade from the{" "}
                <strong>Available Jobs</strong> tab.
              </li>{" "}
              <li>
                Provide your 4-digit start OTP when you reach the customer's
                site.
              </li>{" "}
              <li>
                Customer releases payment directly to your UPI ID (
                <strong className="text-slate-900">{worker.upiId}</strong>) upon
                completion.
              </li>{" "}
            </ul>{" "}
          </div>{" "}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-black text-slate-900 uppercase tracking-wider">
                {" "}
                Showing {filteredJobs.length} Past Completed Assignment
            ...
            {filteredJobs.length === 0 ? (
              <div className="bg-white border border-slate-200 rounded-3xl p-12 text-center space-y-3 shadow-sm max-w-md mx-auto">
                ...
                <h4 className="text-base font-black text-slate-900">
                  No Past Jobs Match Filters
                </h4>{" "}
                <p className="text-xs text-slate-500">
                  {" "}
                  Try changing your search query or trade filters to see other
                  past completed jobs.{" "}
                </p>{" "}
                <button
                  onClick={() => {
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-black text-base tracking-tight">
                    DIHADI OFFICIAL SETTLEMENT RECEIPT
                  </h4>{" "}
                </div>{" "}
                <p className="text-[11px] text-slate-500 mt-0.5">
                  Govt. Verified Hyperlocal Escrow Settlement
                </p>{" "}
              </div>{" "}
              <button
