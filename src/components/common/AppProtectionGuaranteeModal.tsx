      ...
      <div className="bg-white rounded-3xl max-w-xl w-full overflow-hidden shadow-2xl border border-slate-200 flex flex-col max-h-[92vh]">
          ...
          <div className="bg-amber-50/90 border-2 border-amber-300 rounded-2xl p-4 sm:p-5 space-y-2.5 shadow-xs">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-900 mt-1 leading-relaxed font-medium">
                  {" "}
                  If you again hire or engage with{" "}
                  {workerName ? (
            ...
            <div className="bg-white/80 border border-amber-200 rounded-xl p-3 space-y-1.5 text-[11px] text-amber-900 ml-0 sm:ml-11">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  <strong>No Damage Liability:</strong> We are{" "}
                  <strong>NOT responsible</strong> for any damage to you, your
                  family, or your home/property.
                </span>{" "}
              </div>{" "}
              <div className="flex items-center gap-2">
                {" "}
                <span className="w-1.5 h-1.5 rounded-full bg-amber-600 shrink-0" />{" "}
                <span>
                  <strong>No Arrival Protection:</strong> If the worker arrives
                  or fails to show up, we cannot enforce arrival or
                  accountability.
                </span>{" "}
              </div>{" "}
              <div className="flex items-center gap-2">
                ...
                <span className="w-1.5 h-1.5 rounded-full bg-amber-600 shrink-0" />{" "}
                <span>
                  <strong>No Refund or Escrow:</strong> Any cash paid privately
                  outside the app is completely at your own risk.
                </span>{" "}
              </div>{" "}
            </div>{" "}
          </div>{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
              ...
              <div className="bg-white rounded-xl p-3 border border-amber-200 space-y-1">
                ...
                <p className="text-[11px] text-slate-600 leading-snug">
                  {" "}
                  We are accountable for whether the worker arrives on time,
                  completes work properly, and adheres to safety standards.{" "}
                </p>{" "}
              </div>{" "}
              ...
              <div className="bg-white rounded-xl p-3 border border-amber-200 space-y-1">
                ...
                <p className="text-[11px] text-slate-600 leading-snug">
                  {" "}
                  If the worker does not arrive or fails to start, 100% of your
                  prepaid money is instantly refunded with zero deduction.{" "}
                </p>{" "}
              </div>{" "}
              ...
              <div className="bg-white rounded-xl p-3 border border-amber-200 space-y-1">
                ...
                <p className="text-[11px] text-slate-600 leading-snug">
                  {" "}
                  We hold the worker's verified Govt. Aadhaar card on file (
                  {workerAadhaarMasked}) to legally track & identify them at all
                  times.{" "}
                </p>{" "}
              </div>{" "}
        ...
        <div className="p-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between gap-3 shrink-0">
          ...
          >
            ...
            <span>I Understand & Accept App Protection</span>{" "}
