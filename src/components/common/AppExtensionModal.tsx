      ...
      <div className="bg-white dark:bg-[#1E1E1E] rounded-3xl shadow-2xl border border-slate-200 dark:border-[#383838] w-full max-w-xl overflow-hidden animate-in zoom-in-95">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900 dark:text-white">
                Dedicated App Portals & Extensions
              </h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Direct links for Customer (Employer) & Worker apps
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-6 space-y-6">
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
            You can bookmark or share separate direct app extensions for customers and workers. Opening these links will instantly bypass the role selector and open directly into the respective portal.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-slate-50 dark:bg-[#252525] border border-slate-200 dark:border-[#333333] rounded-2xl p-4 flex flex-col justify-between space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  For employers, homeowners, and contractors to post daily jobs & hire workers.
                </p>
              </div>
            ...
            <div className="bg-slate-50 dark:bg-[#252525] border border-slate-200 dark:border-[#333333] rounded-2xl p-4 flex flex-col justify-between space-y-4">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-bold text-sm text-slate-900 dark:text-white">Worker App</h4>
                </div>
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  For daily wage earners, mistris, laborers, and artisans to find work & withdraw wages.
                </p>
              </div>
          ...
          <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200/80 dark:border-amber-900/50 rounded-2xl p-3.5 text-xs text-amber-900 dark:text-amber-200 flex items-start gap-2.5">
            ...
            <p>
              <strong>Tip:</strong> On your phone's browser (Safari/Chrome), open the Customer or Worker link above and select <strong>"Add to Home Screen"</strong> to create independent app icons on your home screen for each!
            </p>
          </div>
