...
interface RateEmployeeModalProps {
  ...
  existingTags?: string[];
  onSubmitRating: (jobId: string, rating: number, review: string, tags: string[]) => void;
}
      ...
      <div className="bg-white rounded-3xl max-w-md w-full overflow-hidden shadow-2xl border border-slate-200 flex flex-col max-h-[92vh]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-950 font-medium">
                Help build trusted work histories on Dihadi
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-4 overflow-y-auto flex-1">
          ...
          >
            ...
            <span>Submit Rating & Finalize</span>
          </button>
        </form>
      </div>
    </div>
