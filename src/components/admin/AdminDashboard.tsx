                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-slate-400 mt-0.5">
                          {req.trade} • {req.experienceYears} Years Experience
                        </p>{" "}
                      </div>{" "}
                      ...
                      {req.status === "pending" ? (
                        ...
                        <div className="flex w-full items-center justify-between">
                          ...
                          <span className="text-amber-400 text-xs font-bold flex items-center gap-1">
                            {" "}
                            <Check className="w-3.5 h-3.5" /> Verified & Visible
                            to Customers{" "}
                          </span>{" "}
                          <button
                            onClick={() =>
                ...
                jobs.map((job) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-[11px] bg-slate-900/80 p-2 rounded-lg border border-slate-800 text-slate-300">
                      ...
                      <span>
                        Worker Payout: <strong>₹{job.workerPayout}</strong> |
                        Commission:{" "}
                        <strong className="text-amber-400">
                          ₹{job.platformFee}
                        </strong>
