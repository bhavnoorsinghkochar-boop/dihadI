    ...
    >
      ...
      <nav className="bg-slate-900 text-white px-4 sm:px-6 lg:px-8 py-3.5 border-b border-slate-800 flex flex-wrap items-center justify-between gap-4 sticky top-0 z-30 shadow-md">
        ...
        <div className="flex items-center gap-1 bg-slate-900/90 p-1.5 rounded-2xl border border-slate-800 text-xs font-bold overflow-x-auto max-w-full">
          ...
          >
            {" "}
            <Search className="w-3.5 h-3.5" /> <span>Find Jobs</span>{" "}
            <span
          ...
          >
            {" "}
            <Clock className="w-3.5 h-3.5" /> <span>Active Work</span>{" "}
          ...
          >
            {" "}
            <History className="w-3.5 h-3.5" /> <span>Job History</span>{" "}
            <span
          ...
          >
            {" "}
            <User className="w-3.5 h-3.5" /> <span>Profile & KYC</span>{" "}
          </button>{" "}
          <button
            onClick={() => {
      ...
      {withdrawalSuccessToast && (
        <div className="bg-amber-600 text-white px-4 py-2.5 text-xs font-bold text-center flex items-center justify-center gap-2 shadow-md animate-fade-in">
          ...
          <CheckCircle2 className="w-4 h-4" />{" "}
          <span>
            ₹{currentWorker.walletBalance} payout triggered to{" "}
            {currentWorker.upiId} via Instant IMPS/UPI!
          </span>{" "}
        </div>
      )}{" "}
      {/* Main Content Body */}
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center space-y-6 animate-fade-in px-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-slate-600 max-w-md mx-auto text-sm sm:text-base leading-relaxed">
                Your profile is currently under review by our admin team. Please wait for some time. 
                Once your account is verified and approved, you will be able to view and accept nearby jobs.
              </p>
            </div>
            ...
            <div className="bg-slate-950 text-white rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-xl border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="max-w-2xl space-y-3.5 z-10">
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tight leading-tight">
                  {" "}
                  Available Job Broadcasts Near You.
                  <br />{" "}
                  <span className="text-[#FCD33F] font-black">
                    Guaranteed Daily Payouts & Zero Middlemen.
                  </span>{" "}
                </h2>{" "}
                <p className="text-xs sm:text-sm text-slate-300 leading-relaxed font-medium">
                  {" "}
                  Live jobs within your 10km neighborhood radius in{" "}
                  {currentWorker.gpsLocation?.city ||
                    currentWorker.location.city}
                  . Payouts credited directly to your UPI upon job
                  completion.{" "}
                </p>{" "}
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-amber-400 font-mono">
                      {" "}
                      Accuracy: ±
                      {currentWorker.gpsLocation?.accuracyMeters || 4}m{" "}
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex justify-between text-[10px] text-slate-400">
                      {" "}
                      <span>1 km (Hyperlocal)</span> <span>5 km</span>{" "}
                      <span>10 km (Max)</span>{" "}
                    </div>{" "}
                  </div>{" "}
                  {/* Min Daily Wage */}{" "}
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <option value="wage_high">
                        Daily Payout (Highest First)
                      </option>{" "}
                      <option value="newest">
                        Broadcast Time (Newest First)
                      </option>{" "}
                    </select>{" "}
                  </div>{" "}
                </div>{" "}
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-black text-slate-900">
                  {" "}
                  {filteredBroadcastJobs.length} Job
                  {filteredBroadcastJobs.length !== 1 ? "s" : ""} Available{" "}
                </span>{" "}
                <span className="px-2 py-0.5 bg-amber-50 text-amber-700 border border-amber-200 text-[10px] font-bold rounded-md flex items-center gap-1">
                  {" "}
                  <ShieldCheck className="w-3 h-3 text-amber-600" /> Within &le;{" "}
                  {maxDistanceKm}km{" "}
                </span>{" "}
              </div>{" "}
              {blockedDistantCount > 0 && (
                <div className="text-xs text-amber-800 bg-amber-50 px-3 py-1 rounded-xl border border-amber-200 flex items-center gap-1.5">
                  ...
                  <span>
                    {blockedDistantCount} distant job(s) &gt; 10km blocked to
                    prevent long travel
                  </span>{" "}
                </div>
              )}{" "}
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-10 text-center space-y-4 shadow-sm max-w-lg mx-auto">
                ...
                <div>
                  ...
                  <h4 className="text-base font-black text-slate-900">
                    No Matching Jobs in Current Filter
                  </h4>{" "}
                ...
                <div className="flex flex-wrap gap-2 justify-center pt-1">
                  ...
                  {totalBroadcastCount > 0 && !showAllCityJobs && (
                    ...
                    >
                      ...
                      <span>
                        Show All Active City Jobs ({totalBroadcastCount})
                      </span>{" "}
                    </button>
                  )}{" "}
                  <button
                    ...
                    <div className="pt-3 border-t border-slate-100 space-y-2.5">
                      ...
                      <div className="flex items-center justify-between text-xs text-slate-500">
                        ...
                        <span className="font-medium">
                          {job.durationDays || 1} Day
                          {(job.durationDays || 1) > 1 ? "s" : ""} Work
                        </span>{" "}
                      </div>{" "}
                      <div className="flex items-center gap-2">
                        {" "}
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xl font-black text-white">
                      Live 10km GPS Radar & Job Scanner
                    </h3>{" "}
                  </div>{" "}
                  <p className="text-xs text-slate-400 mt-1">
                    {" "}
                    Visual scanner detecting job broadcasts within your strict
                    10km radius from ({workerLat.toFixed(4)},{" "}
                    {workerLng.toFixed(4)}){" "}
                  </p>{" "}
                </div>{" "}
                <div className="flex items-center gap-2">
              ...
              <div className="space-y-3 pt-4 border-t border-slate-800">
                ...
                {(filteredBroadcastJobs.length > 0
                  ...
                  <p className="text-xs text-slate-400 italic text-center py-4 bg-slate-950/40 rounded-2xl border border-slate-800">
                    {" "}
                    No active job signals detected within radar range. Keep
                    radar online to receive auto-alerts!{" "}
                  </p>
                ) : (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Live jobs currently assigned to you
                </p>{" "}
              </div>{" "}
            ...
            {myAssignedJobs.length === 0 ? (
              <div className="bg-white border border-slate-200 rounded-3xl p-10 text-center space-y-3 shadow-sm max-w-md mx-auto">
                ...
                <p className="text-xs text-slate-500">
                  {" "}
                  You do not have any jobs currently in progress. Go to Find
                  Jobs to accept new daily assignments!{" "}
                </p>{" "}
                <button
                      ...
                      {job.status === "accepted" ? (
                        <div className="bg-amber-100/70 p-4 rounded-2xl border border-amber-300 text-center space-y-2">
                          ...
                          <h4 className="font-black text-amber-950 text-sm">
                            Waiting for Employer to Approve & Pay
                          </h4>{" "}
                          <p className="text-xs text-amber-800">
                            The customer must complete the prepaid payment to
                            approve you. Once paid, your Start OTP will be sent
                            to the chat.
                          </p>{" "}
                        </div>
                      ) : job.status === "approved" ? (
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div>
                              ...
                              <p className="text-[11px] text-slate-600 mt-0.5">
                                {" "}
                                Ask the customer at the site for their 4-digit
                                passcode to unlock the work clock.{" "}
                              </p>{" "}
                            </div>{" "}
                            {job.otpCode && (
                              <button
            ...
            <div className="space-y-3">
              ...
              {completedJobs.length === 0 ? (
                <div className="bg-white border border-slate-200 rounded-3xl p-8 text-center text-xs text-slate-500">
                  {" "}
                  No completed jobs recorded yet. Accept daily assignments to
                  build your earnings record!{" "}
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500">
                            {job.area} • Employer: {job.customerName}
                          </p>{" "}
                        </div>{" "}
                        <div className="text-right">
                          {" "}
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <h3 className="text-sm font-black text-white leading-tight">
                      Essential Worker Actions
                    </h3>{" "}
                    <p className="text-[11px] text-slate-400">
                      Manage your verified public profile, real-time radar, and
                      showcase portfolio
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
                ...
                <div className="relative group/perf-btn">
                  ...
                  >
                    ...
                    <span className="tracking-wide">
                      Verified by real-world job data
                    </span>{" "}
              ...
              <div className="flex items-center gap-4 p-3 bg-slate-50 border border-slate-100 rounded-2xl">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-slate-500 text-xs mt-0.5">
                    Click photo to take selfie or choose image
                  </p>{" "}
                </div>{" "}
              </div>{" "}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-800">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xl font-black text-white">
                      Kaamzo Worker Support & Safety Hub
                    </h3>{" "}
                  </div>{" "}
                  <p className="text-xs text-slate-400 mt-1">
                    {" "}
                    24/7 dedicated worker welfare, WhatsApp assistance, dispute
                    resolution, and wage protection.{" "}
                  </p>{" "}
                </div>{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-5 bg-slate-800/80 border border-slate-700/80 rounded-3xl space-y-3 shadow-md">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400 mt-0.5">
                      {" "}
                      Toll-free voice assistance and direct WhatsApp messaging
                ...
                <div className="p-5 bg-slate-800/80 border border-slate-700/80 rounded-3xl space-y-3 shadow-md flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400 mt-0.5">
                      {" "}
                      Escalations, KYC verification inquiries, and UPI payout
                      audits.{" "}
                    </p>{" "}
                  </div>{" "}
                  <div className="p-3.5 bg-slate-950/80 rounded-2xl border border-slate-800 space-y-2.5">
                ...
                <div className="p-4 bg-slate-800/60 border border-slate-700 rounded-2xl space-y-2">
                  ...
                  <p className="text-[11px] text-slate-400">
                    {" "}
                    Every customer deposits upfront escrow before work starts.
                    Your hard work is 100% financially secured.{" "}
                  </p>{" "}
                </div>{" "}
                ...
                <div className="p-4 bg-slate-800/60 border border-slate-700 rounded-2xl space-y-2">
                  ...
                  <p className="text-[11px] text-slate-400">
                    {" "}
                    Earnings credit directly to your UPI handle (
                    {currentWorker.upiId}) upon OTP start & completion.{" "}
                  </p>{" "}
                </div>{" "}
              </div>{" "}
              {/* Embedded Gmail OTP Verification Section */}{" "}
