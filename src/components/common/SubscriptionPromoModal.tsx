        ...
        <div className="bg-slate-950/90 px-4 py-2.5 border-b border-slate-800 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            {canSkip ? (
              ...
              >
                {" "}
                <span>Skip Ad</span> <ArrowRight className="w-3.5 h-3.5" />{" "}
              </button>
            ) : (
              ...
              {activeTab === "customer" ? (
                <>
                  ...
                  <div>
                    ...
                    <h4 className="text-xs font-black text-white">
                      Customer Exclusive Membership
                    </h4>{" "}
                    <p className="text-[10px] text-amber-400">
                      1 Month Free Service & Admin Automated Worker Payouts
                    </p>{" "}
                  </div>{" "}
                </>
              ) : (
                <>
                  ...
                  <div>
                    {" "}
                    <h4 className="text-xs font-black text-white">
                      Worker VIP Pass & Verification
                    </h4>{" "}
                    <p className="text-[10px] text-amber-400">
                      Instant Govt. Aadhaar Verified Gold Badge + 0% Commission
                    </p>{" "}
                  </div>{" "}
                </>
              )}{" "}
              ...
              <div className="bg-gradient-to-br from-amber-500/20 via-amber-400/10 to-slate-900 border-2 border-amber-400/80 rounded-3xl p-5 relative overflow-hidden">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-300">
                      {" "}
                      All-inclusive 1 Month Free Service with Automated Admin
                      Payouts{" "}
                    </p>{" "}
                  </div>{" "}
                ...
                <div className="mt-4 pt-3 border-t border-amber-400/30 bg-amber-950/40 p-3 rounded-2xl border border-amber-500/30">
                  ...
                  <div className="flex items-center gap-2 text-xs text-amber-200 font-bold">
                    ...
                    <span>
                      Admin Treasury Auto-Disburses Worker Wages Directly to
                      Worker Wallets!
                    </span>{" "}
                  </div>{" "}
                </div>{" "}
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex items-start gap-2.5 bg-slate-800/80 p-3 rounded-2xl border border-slate-700">
                  ...
                  <div>
                    ...
                    <strong className="text-white">
                      Admin Automated Wallet Transfers:
                    </strong>{" "}
                    <p className="text-slate-400 text-[11px]">
                      {" "}
                      When you hire or book a worker, the platform Admin
                      directly transfers the worker's earnings straight into
                      their wallet automatically.{" "}
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
                <div className="flex items-start gap-2.5 bg-slate-800/80 p-3 rounded-2xl border border-slate-700">
                  ...
                  <div>
                    {" "}
                    <strong className="text-white">
                      1 Month 100% Free Booking (0% Surcharge):
                    </strong>{" "}
                    <p className="text-slate-400 text-[11px]">
                      {" "}
                      Post unlimited jobs with zero platform commission fees for
                      30 full days.{" "}
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
                <div className="flex items-start gap-2.5 bg-slate-800/80 p-3 rounded-2xl border border-slate-700">
                  ...
                  <div>
                    {" "}
                    <strong className="text-white">
                      Free Verified Aadhaar KYC Dossiers:
                    </strong>{" "}
                    <p className="text-slate-400 text-[11px]">
                      {" "}
                      Instant access to official verified worker performance
                      dossiers and police verification badges.{" "}
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
              </div>{" "}
              ...
              <div className="bg-gradient-to-br from-amber-500/20 via-amber-400/10 to-slate-900 border-2 border-amber-400/80 rounded-3xl p-5 relative overflow-hidden">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-300">
                      {" "}
                      Instant Govt Aadhaar Verification + 6 Zero-Commission
                      Jobs{" "}
                    </p>{" "}
                  </div>{" "}
                  <div className="text-right">
                ...
                <div className="mt-4 pt-3 border-t border-amber-400/30 bg-amber-950/40 p-3 rounded-2xl border border-amber-500/30">
                  ...
                  <div className="flex items-center gap-2 text-xs text-amber-200 font-bold">
                    ...
                    <span>
                      Includes Instant Govt. Aadhaar Card Verification — Skip
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex items-start gap-2.5 bg-amber-950/40 p-3 rounded-2xl border border-amber-500/40">
                  ...
                  <div>
                    ...
                    <strong className="text-amber-300">
                      Instant Aadhaar KYC Verification:
                    </strong>{" "}
                    <p className="text-slate-300 text-[11px]">
                      {" "}
                      Your profile is instantly upgraded to "Aadhaar Verified"
                      with an official verified gold badge, attracting 3x more direct
                      customer bookings.{" "}
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
                <div className="flex items-start gap-2.5 bg-slate-800/80 p-3 rounded-2xl border border-slate-700">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-[11px]">
                      {" "}
                      The 20% platform cut is waived for 6 jobs. If the daily
                      wage is ₹900, you keep the full ₹900 in your wallet.{" "}
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
                <div className="flex items-start gap-2.5 bg-slate-800/80 p-3 rounded-2xl border border-slate-700">
                  ...
                  <div>
                    {" "}
                    <strong className="text-white">
                      Top 5 Radar Priority Ranking:
                    </strong>{" "}
                    <p className="text-slate-400 text-[11px]">
                      {" "}
                      Your profile appears at the top of customer search and
                      direct auto-hiring rankings.{" "}
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
              </div>{" "}
