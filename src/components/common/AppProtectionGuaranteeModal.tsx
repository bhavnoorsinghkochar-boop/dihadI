...
export const AppProtectionGuaranteeModal: React.FC<AppProtectionGuaranteeModalProps> = ({
  isOpen,
  onClose,
  variant = 'post_rating',
  workerName,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
              ...
              <div className="bg-white rounded-xl p-3 border border-amber-200 space-y-1">
                ...
                <p className="text-[11px] text-slate-600 leading-snug">
                  We are accountable for whether the worker arrives on time, completes work properly, and adheres to safety standards.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-3 border border-amber-200 space-y-1">
                ...
                <p className="text-[11px] text-slate-600 leading-snug">
                  If the worker does not arrive or fails to start, 100% of your prepaid money is instantly refunded with zero deduction.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-3 border border-amber-200 space-y-1">
                ...
                <p className="text-[11px] text-slate-600 leading-snug">
                  We hold the worker's verified Govt. Aadhaar card on file ({workerAadhaarMasked}) to legally track & identify them at all times.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-3 border border-amber-200 space-y-1">
                ...
                <p className="text-[11px] text-slate-600 leading-snug">
                  Your funds stay locked in the safe Dihadi Escrow Vault and are only released after you confirm total job satisfaction.
                </p>
              </div>
            </div>
          </div>
