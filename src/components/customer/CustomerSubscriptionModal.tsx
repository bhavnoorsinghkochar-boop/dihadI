            ...
            <div className="text-center py-6 space-y-4 animate-in zoom-in-95">
              ...
              <div className="space-y-1">
                ...
                <h3 className="text-xl font-black text-slate-900">
                  Welcome to Dihadi Gold Club!
                </h3>{" "}
                <p className="text-xs text-amber-700 font-bold">
                  {" "}
                  ₹{PRICE.toLocaleString("en-IN")} Subscription Initiated &
                  Received in Admin Account{" "}
                </p>{" "}
                <p className="text-xs text-slate-600 pt-1">
                  {" "}
                  When you hire workers, the{" "}
                  <strong>
                    Admin will automatically disburse worker wages directly to
                    their wallet
                  </strong>{" "}
                  with ₹0 platform surcharge for the next 30 days!{" "}
                </p>{" "}
              </div>{" "}
              <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-left space-y-2 text-xs">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-slate-600">
                    Admin Account Balance Received:
                  </span>{" "}
                ...
                <div className="flex items-center justify-between">
                  {" "}
                  <span className="text-slate-600">
                    Worker Wage Auto-Disbursement:
                  </span>{" "}
                  <span className="font-bold text-amber-700">
                    ⚡ Auto-Paid by Admin to Worker Wallet
                  </span>{" "}
                </div>{" "}
                <div className="flex items-center justify-between">
                  {" "}
            ...
            /* UPI QR Modal Screen */ <div className="space-y-4 text-center animate-in fade-in">
              ...
              <div className="space-y-1">
                ...
                <h3 className="text-lg font-black text-slate-900">
                  Scan UPI QR to Pay ₹{PRICE.toLocaleString("en-IN")}
                </h3>{" "}
...
// pay?pa=dihadi.admin@okhdfcbank&pn=Dihadi%20Admin%20Treasury&am=${PRICE}&cu=INR&tn=Customer%20Gold%2015000%20Subscription`)}`}
            ...
            /* Main Customer Plan Screen */ <>
                ...
                <div className="bg-amber-50 border border-amber-300 rounded-2xl p-3 flex items-center justify-between">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs font-black text-slate-900">
                      {" "}
                      1 Month Free Service Active{" "}
                      {expiryDateFormatted &&
                        `(Until ${expiryDateFormatted})`}{" "}
                    </p>{" "}
                    <p className="text-[11px] text-amber-800 font-medium">
                      {" "}
                      ✨ Worker wages auto-disbursed by Admin directly to worker
                      wallets!{" "}
                    </p>{" "}
                  </div>{" "}
              ...
              <div className="bg-gradient-to-br from-amber-500/10 via-amber-400/20 to-amber-500/10 border-2 border-amber-400 rounded-3xl p-5 relative overflow-hidden">
                ...
                <div className="mt-3 pt-3 border-t border-amber-300/80 flex items-center gap-2 text-xs text-amber-950 font-bold">
                  ...
                  <span>
                    Money credited directly to Admin Account • Admin auto-pays
                    worker wages to their wallet!
                  </span>{" "}
                </div>{" "}
              </div>{" "}
              {/* Key Benefits */}{" "}
                ...
                <div className="grid grid-cols-1 gap-2 text-xs">
                  ...
                  <div className="flex items-start gap-2.5 bg-amber-50/70 p-2.5 rounded-xl border border-amber-200">
                    ...
                    <div>
                      ...
                      <strong className="text-slate-900">
                        Admin Auto-Pays Worker Wallets:
                      </strong>{" "}
                      <p className="text-slate-600 text-[11px]">
                        {" "}
                        When you hire a worker, the platform Admin automatically
                        transfers the worker's earnings straight to their wallet
                        from the admin treasury.{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                  <div className="flex items-start gap-2.5 bg-slate-50 p-2.5 rounded-xl border border-slate-200">
                    ...
                    <div>
                      {" "}
                      <strong className="text-slate-900">
                        1 Month Free Service (Zero Booking Fees):
                      </strong>{" "}
                      <p className="text-slate-500 text-[11px]">
                        {" "}
                        Post unlimited jobs and hire masons, plumbers,
                        electricians with ₹0 platform surcharge.{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                  <div className="flex items-start gap-2.5 bg-slate-50 p-2.5 rounded-xl border border-slate-200">
                    ...
                    <div>
                      {" "}
                      <strong className="text-slate-900">
                        Priority 10km GPS Radar Broadcast:
                      </strong>{" "}
                      <p className="text-slate-500 text-[11px]">
                        {" "}
                        Your job alert is highlighted at the top of nearby
                        worker feeds with priority sirens.{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                  <div className="flex items-start gap-2.5 bg-slate-50 p-2.5 rounded-xl border border-slate-200">
                    ...
                    <div>
                      {" "}
                      <strong className="text-slate-900">
                        Free Verified KYC Dossier Reports:
                      </strong>{" "}
                      <p className="text-slate-500 text-[11px]">
                        {" "}
                        Download official verified background and Aadhaar KYC
                        performance PDF dossiers for free.{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                  <div className="flex items-start gap-2.5 bg-slate-50 p-2.5 rounded-xl border border-slate-200">
                    ...
                    <div>
                      {" "}
                      <strong className="text-slate-900">
                        Dedicated Priority Helpline:
                      </strong>{" "}
                      <p className="text-slate-500 text-[11px]">
                        {" "}
                        Direct phone line to our emergency supervisor for quick
                        worker replacement or dispute help.{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                </div>{" "}
        ...
        <div className="bg-slate-50 p-3 text-center border-t border-slate-200 text-[10px] text-slate-500 shrink-0">
          {" "}
          🛡️ Safe & Secure Payment • Payment deposited into Admin Account •
          Auto-Wallet Payouts Enabled{" "}
        </div>{" "}
      </div>{" "}
    </div>
  );
