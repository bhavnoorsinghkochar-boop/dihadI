              ...
              <form onSubmit={handleLoginSubmit} className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  <label className="font-bold text-slate-700 block mb-1">
                    {" "}
                    {getT(currentLanguage, "auth_user_id_label")} / Mobile /
                    Email{" "}
                  </label>{" "}
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="e.g. User ID, Mobile, or Email"
                      value={loginId}
            ...
            <div className="max-w-2xl space-y-5 z-10">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white leading-tight">
                ...
                <span className="text-amber-400">
                  Get The Job Done With Dignity.
                </span>{" "}
              </h2>{" "}
              <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-normal">
                {" "}
                Connect directly with verified electricians, plumbers,
                carpenters, painters, and masons for daily wage or project
                work.{" "}
              </p>{" "}
              ...
              <div className="flex flex-col sm:flex-row items-stretch gap-2.5 pt-2">
                ...
                <button
                  ...
                  title="Broadcast a new job to verified workers in 10km radius"
                >
                  {" "}
            ...
            <div className="lg:col-span-1 bg-white rounded-3xl p-5 border border-slate-200 shadow-sm space-y-5 sticky top-20">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    {" "}
                    <Crosshair className="w-3 h-3" /> <span>Live GPS</span>{" "}
                  </button>{" "}
                </div>{" "}
                <div className="relative">
                  {" "}
              ...
              <div className="p-3 bg-amber-50/70 border border-amber-200 rounded-2xl space-y-1.5">
                ...
                <p className="text-[10px] text-amber-800 leading-tight">
                  {" "}
                  Guarantees all shown workers are within 10 km of your live GPS
                  coordinates.{" "}
                </p>{" "}
              </div>{" "}
              {/* Min Rating Slider */}{" "}
                ...
                <div className="bg-slate-950 text-white rounded-3xl p-6 border border-slate-800 space-y-4 shadow-xl">
                  ...
                  <div className="flex items-center justify-between text-xs pb-3 border-b border-slate-800">
                    ...
                    <div className="flex items-center gap-2 text-amber-400 font-bold">
                      ...
                      <span>
                        LIVE HYPERLOCAL RADAR • {currentCustomer.area}
                      </span>{" "}
                  ...
                  {selectedRadarWorker ? (
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              ...
                              <span className="text-base font-black text-amber-400">
                                ₹{selectedRadarWorker.dailyRate}/day
                              </span>{" "}
                    ...
                    <p className="text-center text-xs text-slate-400 py-2">
                      {" "}
                      Tap any blip on the 10km radar to inspect distance,
                      initiate calls, or book directly.{" "}
                    </p>
                  )}{" "}
                </div>
              )}{" "}
                  ...
                  {filteredWorkers.length === 0 ? (
                    <div className="bg-white rounded-3xl p-10 text-center space-y-3 border border-slate-200 shadow-sm">
                      ...
                      <h4 className="text-base font-black text-slate-800">
                        No Workers Found Matching Filter
                      </h4>{" "}
                      <p className="text-xs text-slate-500 max-w-md mx-auto">
                        {" "}
                        There are no workers matching your criteria within the
                        strict 10km radar. Try resetting filters or broadcast a
                        custom job.{" "}
                      </p>{" "}
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <h3 className="text-xl font-black text-slate-900">
                My Bookings & Active Work Orders
              </h3>{" "}
              <p className="text-xs text-slate-500">
                {" "}
                Track assigned workers, verify start OTPs, monitor 10km GPS
                routes, and release UPI payments.{" "}
              </p>{" "}
            </div>{" "}
            <button
              onClick={() => setShowPostModal(true)}
            ...
            >
              {" "}
              <Plus className="w-4 h-4" /> <span>Post New Job</span>{" "}
            </button>{" "}
          </div>{" "}
          {activeRequests.length === 0 ? (
            <div className="bg-white rounded-3xl p-12 text-center space-y-3 border border-slate-200 shadow-sm">
              ...
              <p className="text-xs text-slate-500 max-w-md mx-auto">
                {" "}
                You haven&apos;t posted any job or booked a worker yet. Browse
                available workers or post a requirement.{" "}
              </p>{" "}
              <button
                onClick={() => setActiveTab("find_workers")}
              ...
              >
                {" "}
                <Users className="w-4 h-4" /> <span>Find Workers Now</span>{" "}
              </button>{" "}
            </div>
          ) : (
                    ...
                    <div className="bg-amber-100 p-4 rounded-2xl border border-amber-300 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-600 mt-1">
                          Please pay the prepaid amount into escrow to approve
                          this worker and release the start OTP.
                        </p>{" "}
                      </div>{" "}
                      <div className="flex gap-2">
                        ...
                        >
                          {" "}
                          Pay ₹{job.dailyWage * job.durationDays} to
                          Approve{" "}
                        </button>{" "}
                      </div>{" "}
                    </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-amber-200/60 pb-3">
                        ...
                        <div className="space-y-0.5">
                          ...
                          <p className="text-[11px] text-slate-600 leading-snug">
                            {" "}
                            Share this 4-digit code with the worker upon
                            doorstep arrival. The worker enters it to begin the
                            verified work clock.{" "}
                          </p>{" "}
                        </div>{" "}
                  ...
                  {(job.status === "accepted" ||
                    ...
                    <div className="flex items-center justify-between px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs mt-4">
                      ...
                      <span className="text-[11px] text-slate-600 font-medium">
                        Worker not arrived or left site?
                      </span>{" "}
                      <button
                        type="button"
                        onClick={() => {
                    ...
                    <div className="bg-amber-50/90 border-2 border-amber-400 p-4 rounded-2xl space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-black text-amber-950 uppercase tracking-wide">
                            {" "}
                            Complaint Registered for Admin Review (#
                            {job.disputeId || "DISP"}){" "}
                          </span>{" "}
                        </div>{" "}
                      ...
                      <div className="bg-white p-2.5 rounded-xl border border-amber-200 text-[11px] text-slate-700 space-y-1">
                        ...
                        <p className="text-[10px] text-slate-600">
                          {" "}
                          Admin Operations is auditing worker GPS timestamps &
                          proof. Upon verification, 100% of your escrow will be
                          refunded or wage appropriately adjusted. No direct
                          1-click refund allows fraudulent claims.{" "}
                        </p>{" "}
                      </div>{" "}
                    </div>
                  )}{" "}
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            <h5 className="text-xs font-black text-slate-950">
                              Work Completed • Covered by Gold Membership
                            </h5>{" "}
                          </div>{" "}
                          <p className="text-[11px] text-slate-700 mt-0.5">
                            {" "}
                            Worker wage of ₹{job.workerPayout} will be disbursed
                            directly from Admin Treasury.{" "}
                            <strong>₹0 charged to your account.</strong>
                            <br />{" "}
                            <strong className="text-amber-800">
                              The worker has completed the job. Please leave a
                              rating and review for your experience!
                            </strong>{" "}
                          </p>{" "}
                        </div>{" "}
                        <div className="flex items-center gap-2">
        ...
        <div className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 max-w-4xl mx-auto w-full">
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
              <div>
                <h3 className="text-xl font-black text-slate-900">
                  Kaamzo Customer Support & Safety Hub
                </h3>
                <p className="text-xs text-slate-500 mt-1">
                  24/7 dedicated voice assistance, WhatsApp helpline, dispute
                  resolution, and hyperlocal safety.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-5 bg-gradient-to-br from-amber-50/80 to-amber-100/40 border border-amber-200 rounded-3xl space-y-3 shadow-xs">
                ...
                <div>
                  <h4 className="text-sm font-black text-slate-900">
                    IVR Voice & WhatsApp Helpline
                  </h4>
                  <p className="text-[11px] text-slate-600 mt-0.5">
                    Toll-free voice assistance and instant WhatsApp messaging in
              ...
              <div className="p-5 bg-slate-50 border border-slate-200 rounded-3xl space-y-3 shadow-xs flex flex-col justify-between">
                <div>
                  ...
                  <h4 className="text-sm font-black text-slate-900">
                    Official Helpline Gmail
                  </h4>
                  <p className="text-[11px] text-slate-600 mt-0.5">
                    Escalations, billing audits, dispute queries, and security
                    reports.
                  </p>
                </div>
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-2">
                ...
                <p className="text-[11px] text-slate-500">
                  Every worker in your 10km radius is verified with physical
                  trade proof and government identity documents.
                </p>
              </div>
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-2">
                ...
                <p className="text-[11px] text-slate-500">
                  Your payments are locked safely in escrow and only released
                  after you verify completed work on site.
                </p>
              </div>
            </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-3 border border-slate-200 mt-2 space-y-2">
                ...
                <div className="space-y-1.5 text-[11px] sm:text-xs">
                  ...
                  <div className="flex items-center justify-between text-slate-700">
                    {" "}
                    <span>
                      Base Labor ({bookingWorker.dailyRate} ×{" "}
                      {directJobDuration} days):
                    </span>{" "}
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Auto-broadcasts to all verified workers within 10 km.
                  </p>{" "}
                </div>{" "}
              </div>{" "}
              <button
            ...
            <form onSubmit={handlePostJobSubmit} className="space-y-4 text-xs">
              ...
              <div className="bg-amber-50/90 border border-amber-200/90 rounded-2xl p-3.5 sm:p-4 text-xs text-amber-950 flex items-start gap-3 shadow-xs">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-amber-900/90 text-[11px] sm:text-xs leading-relaxed">
                    {" "}
                    &ldquo;If the worker is ordered not by the website but
                    externally by calling or other sources, we are not
                    responsible for any theft or damage done by him.&rdquo;{" "}
                  </p>{" "}
                </div>{" "}
              </div>{" "}
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="font-black text-slate-900 text-xs sm:text-sm">
                    {" "}
                    Service Category (Official Hourly Rate){" "}
                  </label>{" "}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Custom Woodwork & Repair"
                    value={title}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Bring wood tools and nails"
                    value={description}
              ...
              <div className="bg-amber-50/90 border border-amber-200/90 rounded-2xl p-4 sm:p-5 space-y-2.5 text-xs text-slate-800 shadow-xs">
                ...
                <div className="space-y-1.5 pt-0.5">
                  ...
                  <div className="flex items-center justify-between text-slate-700">
                    {" "}
                    <span>
                      Base Labor ({activeGovHourlyRate} × {hoursPerDay}h ×{" "}
              ...
              <div className="pt-2 flex items-center gap-3">
                ...
                >
                  ...
                  <span>
                    Post Job & Broadcast (₹{totalCustomerPayment})
                  </span>{" "}
                </button>{" "}
              </div>{" "}
            </form>{" "}
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Official review by Kaamzo Operations & Admin
                  </p>{" "}
                </div>{" "}
              </div>{" "}
              <button
            ...
            <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200 space-y-1 text-xs">
              ...
              <div className="flex items-center justify-between text-slate-600 text-[11px]">
                ...
                <span className="font-mono text-amber-700 font-bold">
                  Escrow: ₹
                  {complaintJob.escrowPrepaidAmount ||
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <option value="Worker did not arrive at site / Absent">
                    Worker did not arrive at site / Absent (ਗੈਰ-ਹਾਜ਼ਰ)
                  </option>{" "}
                  <option value="Worker left site without completing work">
                    Worker left site early without finishing work
                  </option>{" "}
                  <option value="Severe quality defect or property damage">
                    Substandard work / Quality defect / Damage
                  </option>{" "}
                  <option value="Worker demanded unauthorized extra cash">
                    Worker demanded unauthorized extra cash outside app
                  </option>{" "}
              ...
              <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-[11px] text-amber-900 space-y-1">
                ...
                <p className="text-amber-800">
                  {" "}
                  To prevent fraudulent disputes, Kaamzo Admin will cross-verify
                  worker GPS location logs and timestamps.{" "}
                  <strong>
                    100% of your escrow funds are held safely locked in escrow
                    vault
                  </strong>{" "}
                  and will be refunded upon verification.{" "}
                </p>{" "}
              </div>{" "}
              <div className="pt-2 flex items-center gap-2">
                {" "}
