    ...
    <div className="w-full flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-bold text-slate-900">
              Live Real-Time Cross-App Sync
            </h2>
            <p className="text-xs text-slate-500">
              Post a job in Employer App ➔ Worker App receives instant radar alert ➔ Worker accepts ➔ Share OTP ➔ Mark done ➔ Payout releases to wallet & Admin tracks live.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="bg-white rounded-[2.5rem] border-[12px] border-slate-900 shadow-2xl h-[580px] overflow-hidden flex flex-col">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="bg-slate-900 rounded-[2rem] shadow-2xl h-[580px] overflow-hidden flex flex-col border border-slate-700 p-1">
