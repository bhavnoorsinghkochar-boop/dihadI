  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 overflow-y-auto animate-in fade-in duration-200 select-none">
      <div className="bg-white text-slate-900 w-full max-w-3xl rounded-3xl border border-slate-200 shadow-2xl overflow-hidden flex flex-col my-auto max-h-[92vh]">
        {/* Header Banner */}
        <div className="bg-gradient-to-r from-amber-600 via-amber-600 to-amber-700 text-white p-4 sm:p-5 shrink-0 flex items-center justify-between border-b border-amber-500/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-amber-100 font-medium flex items-center gap-1">
              ...
              <h3 className="text-lg font-black text-white flex items-center gap-2 mt-0.5">
                ...
                <span className="text-xs font-normal text-amber-200">({job.title})</span>
              </h3>
            </div>
          </div>
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl p-4 transition-all duration-200 border relative ${
                    isTopRank
                      ? 'bg-amber-50/70 border-amber-300 shadow-sm ring-1 ring-amber-400/40'
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-0.2 bg-amber-100 text-amber-800 text-[10px] font-black rounded-full border border-amber-300">
                        ...
                        <p className="text-xs text-slate-500 flex items-center gap-2 mt-0.5">
                          ...
                          <span>•</span>
                          <span className="text-amber-600 font-bold">~{item.etaMinutes}m ETA</span>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <span className="text-[10px] font-bold text-amber-700 bg-amber-50 px-1.5 py-0.5 rounded border border-amber-200 mt-0.5 block">
                        🛡️ Prepaid Escrow
                      </span>
                  ...
                  <div className="mt-3 bg-white/80 p-2.5 rounded-xl border border-slate-200 text-xs flex items-center justify-between gap-2">
                    ...
                    {item.isWithin10Km && (
                      <span className="px-2 py-0.5 bg-amber-100 text-amber-800 text-[9px] font-black uppercase rounded shrink-0">
                        Strict 10km Zone
                      </span>
                    )}
                  </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 sm:grid-cols-5 gap-2 text-xs">
                    ...
                    <button
                      ...
                      className="py-2 bg-amber-600 hover:bg-amber-500 text-white font-black rounded-xl transition flex items-center justify-center gap-1.5 shadow-sm"
                    >
                    ...
                    <button
                      ...
                      className="py-2 bg-amber-50 hover:bg-amber-100 text-amber-700 font-bold rounded-xl border border-amber-200 transition flex items-center justify-center gap-1.5"
                    ...
                    <button
                      ...
                      className="py-2 bg-amber-50 hover:bg-amber-100 text-amber-800 font-bold rounded-xl border border-amber-200 transition flex items-center justify-center gap-1.5"
                    >
